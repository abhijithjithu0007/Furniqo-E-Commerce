      ...
      <div className={`fixed top-0 left-0 h-full bg-[#1E293B] z-10 overflow-y-auto transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 md:w-64`}>
        ...
        <div className="flex-grow overflow-y-auto">
          <ul className="flex flex-col py-4 space-y-1">
            <li>
              <Link to='/admin/dashboard' className="relative flex items-center h-11 focus:outline-none hover:bg-gray-500 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <li>
              <Link to='/admin/products' className="relative flex items-center h-11 focus:outline-none hover:bg-gray-500 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-btnColor pr-6">
                <span className="inline-flex justify-center items-center ml-4">
                  <HiShoppingBag />
                </span>
            ...
            <li>
              <Link to="/admin/users" className="relative flex items-center h-11 focus:outline-none hover:bg-gray-500 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                <span className="inline-flex justify-center items-center ml-4">
                  <PiUsersFourFill />
                </span>
